...
public class personaDAO {
	    ...
	    if (persona != null && persona.getNombre() != null && !persona.getNombre().isEmpty()) {
	        try (BufferedWriter writer = new BufferedWriter(new FileWriter(archivo, true))) {
	            String linea = persona.getNombre() + ";" +
	                           ...
	                           persona.isFavorito();
		        System.out.println("en escribir archico" +persona.isFavorito());
	...
	public void actualizarContactos(List<persona> personas) throws IOException {
	    // ✅ En lugar de borrar el archivo, lo sobrescribimos correctamente
	    try (BufferedWriter writer = new BufferedWriter(new FileWriter(archivo, false))) { // false = sobrescribir
	        for (persona p : personas) {
	            String linea = p.getNombre() + ";" +
	                           ...
	                           p.getCategoria() + ";" +
	                           p.isFavorito();
	            System.out.println("metodo dentro dentro modificar" + p.isFavorito());
